...
const char* HitBoxes::getModuleName() {
	name = string("碰撞箱 ") + string(GRAY) + to_string((int)height) + string(".") + to_string((int)(height * 10) - ((int)height * 10)) + " " + to_string((int)width) + string(".") + to_string((int)(width * 10) - ((int)width * 10));
	return name.c_str();
}
