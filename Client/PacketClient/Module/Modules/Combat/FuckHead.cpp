...
FuckHead::FuckHead() : IModule(VK_NUMPAD0, Category::COMBAT, "Fuckhead By Dimpless") {
...
void FuckHead::onPreRender(C_MinecraftUIRenderContext* renderCtx) {
	if (only) {
		...
		DrawUtils::drawBox(vec3_ti(mid1).toVector3(), vec3_ti(mid1).toVector3().add(1), .4f, true);
	}
	else
	{
		DrawUtils::setColor(.7466765f, .3052124f, 1.f, 1.f); // 138,27,255
		DrawUtils::drawBox(vec3_ti(mid1).toVector3(), vec3_ti(mid1).toVector3().add(1), .4f, true);
		DrawUtils::setColor(.7466765f, .3052124f, 1.f, 1.f); // 138,27,255
		DrawUtils::drawBox(vec3_ti(bottom2).toVector3(), vec3_ti(bottom2).toVector3().add(1), .4f, true);
		DrawUtils::setColor(.7466765f, .3052124f, 1.f, 1.f); // 138,27,255
		DrawUtils::drawBox(vec3_ti(bottom1).toVector3(), vec3_ti(bottom1).toVector3().add(1), .4f, true);
		DrawUtils::setColor(.7466765f, .3052124f, 1.f, 1.f); // 138,27,255
		DrawUtils::drawBox(vec3_ti(bottom3).toVector3(), vec3_ti(bottom3).toVector3().add(1), .4f, true);
		DrawUtils::setColor(.7466765f, .3052124f, 1.f, 1.f); // 138,27,255
		DrawUtils::drawBox(vec3_ti(bottom4).toVector3(), vec3_ti(bottom4).toVector3().add(1), .4f, true);
	}
