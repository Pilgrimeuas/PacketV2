...
const char* Criticals::getModuleName() {
	if (mode.getSelectedValue() == 0)  name = string("刀爆 ") + string(GRAY) + string("Vanilla");
	if (mode.getSelectedValue() == 1)  name = string("刀爆 ") + string(GRAY) + string("Position");
	if (mode.getSelectedValue() == 2)  name = string("刀爆 ") + string(GRAY) + string("Jump");
	if (mode.getSelectedValue() == 3)  name = string("刀爆 ") + string(GRAY) + string("Hive");
	if (mode.getSelectedValue() == 4)  name = string("刀爆 ") + string(GRAY) + string("Patch");
	return name.c_str();
}
