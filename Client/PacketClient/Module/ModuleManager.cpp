...
void ModuleManager::initModules() {
	{
		...
		moduleList.push_back(std::shared_ptr<IModule>(new Dupe()));
		moduleList.push_back(std::shared_ptr<IModule>(new BurrowWTF()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new AutoTimer()));
		...
		moduleList.push_back(std::shared_ptr<IModule>(new ADisabler()));
